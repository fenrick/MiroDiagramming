...
declare module '@mirohq/websdk-types/core/commander' {
  ...
  export interface Commander<AllowedCommandTypes extends string> {
    exec<ReturnType = unknown, PayloadType = unknown>(
      commandName: AllowedCommandTypes,
      payload?: PayloadType,
    ): Promise<ReturnType>
...
declare module '@mirohq/websdk-types/core/features/dragAndDrop' {
  ...
  export function attachDragAndDropListeners(
    commander: Commander<string>,
    handler: DropEventListener,
  ): Promise<void>
  export function detachDragAndDropListeners(
    commander: Commander<string>,
    handler: DropEventListener,
  ): Promise<void>
}
...
declare module '@mirohq/websdk-types/core/SdkPostMessageBus' {
  ...
  export class SdkPostMessageBus {
    ...
    constructor(
      hostWindow: Window,
      clientOrigin: string,
      messageHandler: (commands: unknown) => Promise<unknown[]>,
...
declare module '@mirohq/websdk-types/core/index' {
  ...
  } from '@mirohq/websdk-types/core/commander'
  ...
  export {
    ...
    getTransferable,
  } from '@mirohq/websdk-types/core/utils'
...
declare module '@mirohq/websdk-types/core/features/widgets/connector' {
  ...
  import {
    ...
    TextAlignVertical,
    TextOrientation,
  } from '@mirohq/websdk-types/core/api/common'
...
declare module '@mirohq/websdk-types/core/builder/types' {
  ...
  export type CamelCase<S extends string> = S extends `${infer First}_${infer Rest}`
    ? `${Capitalize<First>}${CamelCase<Rest>}`
    : Capitalize<S>
  ...
  export type SdkClient<Item extends BaseItem, Definition extends GenericObject> =
    Definition extends BaseFeature<Item>
      ? Identity<BaseFeature<Item> & Omit<Definition, keyof BaseFeature<Item>>>
      : Definition
  export type SdkClientFeature<
    CmdTypes extends string = string,
    Item extends BaseItem = BaseItem,
    FeatureDefinition extends GenericObject = GenericObject,
  > = (ctx: Context<CmdTypes, Item>) => FeatureDefinition
  ...
  export type ItemConstructor<Item extends BaseItem, CmdTypes extends string, CreateProps> =
    CreateProps extends ItemProps<Item>
      ? new (context: Context<CmdTypes, BaseItem>, props: CreateProps) => Item
      : never
  ...
  export type ItemDeclaration<
    ...
    CmdTypes extends string = string,
    CreateProps = Item,
  > = ItemConstructor<Item, CmdTypes, CreateProps> | ItemCreator<Item, CmdTypes, CreateProps>
  export type SdkClientBuilder<
    CmdTypes extends string,
    Item extends BaseItem,
    Definition extends GenericObject,
  > = {
    widget: <NewItem extends BaseItem, NewCreateProps = NewItem>(
      key: NewItem['type'],
      declaration: ItemDeclaration<NewItem, CmdTypes, NewCreateProps>,
    ) => SdkClientBuilder<
      CmdTypes,
      | Exclude<
          Item,
      ...
      Identity<
        {
          [K in NewItem as `create${CamelCase<K['type']>}`]: undefined extends NewCreateProps
            ? (props?: NewCreateProps) => Promise<K>
            : (props: NewCreateProps) => Promise<K>
        } & Definition
      >
    >
    use<NewDefinition extends GenericObject>(
      feature: SdkClientFeature<CmdTypes, Item, NewDefinition>,
    ): SdkClientBuilder<CmdTypes, Item, NewDefinition & Omit<Definition, keyof NewDefinition>>
  ...
  export type InferItemFromContext<T> =
    T extends Context<infer _CmdTypes, infer Item> ? Item : never
  export type InferItemFromClient<T> =
    T extends SdkClient<infer Item, infer _CmdType> ? Item | Unsupported : never
  export type InferClientFromBuilderState<T> =
    T extends SdkClientBuilder<infer _CmdType, infer _Item, infer _Definition>
      ? ReturnType<T['build']>
      : never
}
...
declare module '@mirohq/websdk-types/core/features/eventManager' {
  ...
  export class EventManager<EventType extends string = string> {
    ...
    subscribe<External extends Listener>(
      event: EventType,
      externalHandler: External,
      internalHandler: RemoteCommandHandler,
    ): Promise<void>
    unsubscribe<External extends Listener>(
      event: EventType,
      externalHandler: External,
    ): Promise<void>
...
declare module '@mirohq/websdk-types/stable/api/board' {
  ...
  export type UserInfoWithEmail = Identity<
    UserInfo & {
      email: string
    }
  >
...
declare module '@mirohq/websdk-types/stable/features/widgets/frame' {
  ...
  import {
    ...
    Identity,
    ItemProps,
    BaseItem as BaseItemType,
  } from '@mirohq/websdk-types/core/builder/types'
  import { BaseItem } from '@mirohq/websdk-types/core/features/widgets/base'
  import type { AppCard } from '@mirohq/websdk-types/stable/features/widgets/appCard'
...
declare module '@mirohq/websdk-types/stable/api/widgets/group' {
  ...
  export type {
    ...
    CreateGroupProps,
    GroupableItem,
  } from '@mirohq/websdk-types/stable/features/widgets/group'
...
declare module '@mirohq/websdk-types/stable/api/collaboration' {
  ...
  export type Session = {
    ...
    on(
      name: 'invitation-responded',
      handler: (event: InvitationResponseEvent) => Promise<void>,
    ): Promise<void>
  ...
  export type Collaboration = {
    ...
    on(
      name: 'sessions:started' | 'sessions:ended',
      handler: (event: SessionsLifecycleEvent) => void,
    ): Promise<void>
    off(
      name: 'sessions:started' | 'sessions:ended',
      handler: (event: SessionsLifecycleEvent) => void,
...
declare module '@mirohq/websdk-types/stable/api/storage' {
  ...
  export type Collection = {
    ...
    onValue<T extends Json = Json>(
      key: string,
      handler: (value: T | undefined, version: string) => void,
    ): Promise<void>
    offValue<T extends Json = Json>(
      key: string,
      handler: (value: T | undefined, version: string) => void,
    ): Promise<void>
  }
...
declare module '@mirohq/websdk-types/stable/api/ui' {
  ...
  import {
    ...
    SessionEventType,
  } from '@mirohq/websdk-types/stable/api/collaboration'
  ...
  export type UIEventType =
    ...
    | CustomEventType
    | ItemsEventType
  export type EventTypeUnprefixed =
    | 'drop'
    | 'icon:click'
    | 'app_card:open'
    | 'app_card:connect'
  ...
  >
  export type BoardUI = {
    openPanel<Data = undefined, Result = undefined>(
      options: OpenPanelOptions<Data>,
    ): Promise<{
    ...
    openModal<Data = undefined, Result = undefined>(
      options: OpenModalOptions<Data>,
    ): Promise<{
      waitForClose: () => Promise<Result | undefined>
    }>
...
declare module '@mirohq/websdk-types/stable/api/commands' {
  export type CommandType =
    ...
    | 'UI_OPEN_MODAL'
    | 'UI_GET_MODAL_DATA'
    | 'UI_WAIT_FOR_MODAL_CLOSE'
    | 'UI_CLOSE_MODAL'
    | 'UI_CAN_OPEN_MODAL'
    | 'UI_OPEN_PANEL'
    | 'UI_GET_PANEL_DATA'
    | 'UI_WAIT_FOR_PANEL_CLOSE'
    | 'UI_CLOSE_PANEL'
    | 'UI_CAN_OPEN_PANEL'
    | 'VIEWPORT_GET'
    | 'VIEWPORT_SET'
    ...
    | 'SESSIONS_END'
    | 'SESSIONS_GET'
    | 'SESSIONS_INVITE_USERS'
    | 'SESSIONS_JOIN'
    | 'SESSIONS_LEAVE'
    | 'SESSIONS_USER_JOINED'
    | 'COLLABORATION_VIEWPORT_ZOOM_TO'
    | 'SEND_REALTIME_BROADCAST_EVENT'
    | 'TIMER_GET'
    | 'TIMER_START'
    | 'TIMER_IS_STARTED'
    | 'TIMER_PROLONG'
    ...
    | 'GROUP_UNGROUP'
    | 'ATTENTION_FOLLOW'
    | 'ATTENTION_IS_FOLLOWING'
    | 'ATTENTION_GET_FOLLOWED_USER'
    | 'ATTENTION_UNFOLLOW'
    | 'FIND_EMPTY_SPACE'
}
...
declare module '@mirohq/websdk-types/stable/features/notifications' {
  ...
  import {
    ...
    NotificationOptions,
  } from '@mirohq/websdk-types/stable/api/notifications'
...
declare module '@mirohq/websdk-types/experimental/api/commands' {
  import { CommandType } from '@mirohq/websdk-types/stable/api/commands'
  export type ExperimentalCommandType =
    | CommandType
    | 'CUSTOM_ACTION_REGISTER'
    | 'CUSTOM_ACTION_DEREGISTER'
    | 'FIND_EMPTY_SPACE'
    | 'GET_VOTING_RESULTS'
    | 'HISTORY_CAN_UNDO'
    | 'HISTORY_UNDO'
...
declare module '@mirohq/websdk-types/stable/features/timer' {
  ...
  import {
    ...
    TimerEventType,
    TimerInstance,
  } from '@mirohq/websdk-types/stable/api/timer'
...
declare module '@mirohq/websdk-types/stable/features/attention' {
  ...
  } from '@mirohq/websdk-types/stable/api/attention'
  import { OnlineUserInfo } from '@mirohq/websdk-types/stable/api/board'
...
declare module '@mirohq/websdk-types/stable/features/entities/session' {
  ...
  export class Session implements ISession {
    ...
    constructor(
      ...
      starterId: string,
      starterName: string,
      commander: Commander<CommandType>,
    )
    invite(...users: OnlineUserInfo[] | OnlineUserInfo[][]): Promise<void>
    join(): Promise<void>
    leave(): Promise<void>
...
declare module '@mirohq/websdk-types/stable/features/collaboration' {
  ...
  import {
    Collaboration as ICollaboration,
    SessionStartProps,
  } from '@mirohq/websdk-types/stable/api/collaboration'
  import { BaseItem } from '@mirohq/websdk-types/stable/api/client'
  import { OnlineUserInfo } from '@mirohq/websdk-types/stable/api/board'
...
declare module '@mirohq/websdk-types/stable/features/storage' {
  ...
  import {
    ...
    Storage as IStorage,
  } from '@mirohq/websdk-types/stable/api/storage'
  export class Collection implements ICollection {
    ...
    onValue<T extends Json = Json>(
      key: string,
      handler: (payload: T | undefined, version: string) => void,
    ): Promise<void>
    offValue<T extends Json = Json>(
      key: string,
      handler: (payload: T | undefined, version: string) => void,
...
declare module '@mirohq/websdk-types/core/builder/client' {
  ...
  export function buildSdkClient<
    CmdTypes extends string = string,
    Item extends BaseItem = never,
    ClientDefinition extends GenericObject = GenericObject,
    CreateProps extends {
      type: Item['type']
      props: unknown
    } = {
  ...
  >(
    baseClient?: SdkClientBuilder<CmdTypes, Item, ClientDefinition>,
  ): SdkClientBuilder<CmdTypes, Item, ClientDefinition>
}
declare module '@mirohq/websdk-types/core/features/base.client' {
  import {
    BaseFeature,
    Context,
    InferItemFromContext,
  } from '@mirohq/websdk-types/core/builder/types'
  export const baseClientFeature: <
    Ctx extends Context,
    Item extends InferItemFromContext<Ctx> = InferItemFromContext<Ctx>,
  >(
    ctx: Ctx,
  ) => BaseFeature<Item>
}
declare module '@mirohq/websdk-types/experimental/features/widgets/mindmapNode' {
  ...
  export type MindmapNodeView = Omit<MindmapTextNodeView, 'type'> &
    Omit<MindmapShapeNodeView, 'type'> &
    MindmapNodeViewTypeUnion
  export type MindmapNodeViewUnion =
    | PartialExcept<MindmapTextNodeView, 'type'>
    | PartialExcept<MindmapShapeNodeView, 'type'>
  ...
  export const mindmapNodeDefinition: {
    ...
    create: (
      ctx: Context,
      props?: Identity<Omit<MindmapNodeCreate, 'type'>>,
    ) => Promise<MindmapNode>
  }
}
...
declare module '@mirohq/websdk-types/stable/features/board' {
  ...
  import {
    ...
    OnlineUserInfo,
    UserInfo,
  } from '@mirohq/websdk-types/stable/api/board'
  import { AppData, AppDataValue } from '@mirohq/websdk-types/core/api/data'
  ...
  export const boardFeature: <T extends Context>(
    ctx: T,
  ) => {
    ...
    getAppData<K extends string | undefined = undefined>(
      key?: K,
    ): Promise<K extends string ? AppDataValue : AppData>
    ...
    getMetadata<K_1 extends string | undefined = undefined>(
      item: BaseItem,
      key?: K_1 | undefined,
    ): Promise<K_1 extends string ? import('@mirohq/websdk-types/core/api/common').Json : AppData>
...
declare module '@mirohq/websdk-types/core/api/widgets/connector' {
  ...
  export type {
    ...
    ConnectorStyle,
    SnapToValues,
  } from '@mirohq/websdk-types/core/features/widgets/connector'
...
declare module '@mirohq/websdk-types/stable/api/widgets/card' {
  ...
  export type {
    ...
    CardField,
    CardAssignee,
  } from '@mirohq/websdk-types/stable/features/widgets/card'
...
declare module '@mirohq/websdk-types/stable/api/widgets/frame' {
  ...
  export type {
    FrameStyle,
    ContainableItem,
  } from '@mirohq/websdk-types/stable/features/widgets/frame'
...
declare module '@mirohq/websdk-types/stable/api/widgets/stickyNote' {
  ...
  import {
    StickyNoteColor,
    StickyNote,
  } from '@mirohq/websdk-types/stable/features/widgets/stickyNote'
  export type {
    StickyNoteColorType,
    StickyNoteShape,
    StickyNoteStyle,
...
declare module '@mirohq/websdk-types/experimental/features/widgets/frame' {
  ...
  export type ContainableItem = FlattenUnion<
    Exclude<Stable.ContainableItem, Stable.Shape | Stable.Group> | MindmapNode | Shape | Group
  >
  export class Frame extends BaseFrame<ContainableItem> {}
}
declare module '@mirohq/websdk-types/experimental/features/widgets/group' {
  ...
  import type { MindmapNode } from '@mirohq/websdk-types/experimental/features/widgets/mindmapNode'
  import type { Shape } from '@mirohq/websdk-types/experimental/features/widgets/shape'
  export type GroupableItem = FlattenUnion<
    Exclude<Stable.GroupableItem, Stable.Shape | Stable.Frame> | Frame | MindmapNode | Shape
  >
  export type CreateGroupProps = {
    items: GroupableItem[]
  }
...
declare module '@mirohq/websdk-types/experimental/client/index' {
  ...
  export const experimentalSdkClientSchema: import('@mirohq/websdk-types/core/builder/types').SdkClientBuilder<
    string,
    | import('@mirohq/websdk-types/stable/index').Connector
    | import('@mirohq/websdk-types/stable/index').Card
    | import('@mirohq/websdk-types/stable/index').AppCard
    | import('@mirohq/websdk-types/stable/index').Tag
    | import('@mirohq/websdk-types/stable/index').Embed
    | import('@mirohq/websdk-types/stable/index').Image
    | import('@mirohq/websdk-types/stable/index').Preview
    | import('@mirohq/websdk-types/stable/index').StickyNote
    | import('@mirohq/websdk-types/stable/index').Text
    | import('@mirohq/websdk-types/experimental/features/widgets/mindmapNode').MindmapNode
    | Shape
    | Group
    | Frame,
    {
      action: import('@mirohq/websdk-types/experimental/features/customAction').CustomActionManagement
      history: import('@mirohq/websdk-types/experimental/features/history').History
      getVotingResults(): Promise<
        import('@mirohq/websdk-types/experimental/api/board').VotingResult[]
      >
      group(
        props: import('@mirohq/websdk-types/experimental/features/widgets/group').CreateGroupProps,
      ): Promise<Group>
    } & Omit<
      {
        createFrame: ((
          props?:
            | {
                style?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<{
                      fillColor: string
                    }>
                  | undefined
                ...
                relativeTo?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/index').RelativeTo
                    >
                  | undefined
                readonly parentId?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<string | null>
                  | undefined
                readonly groupId?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  string | undefined
                >
                ...
                linkedTo?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  string | undefined
                >
                readonly connectorIds?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  string[] | undefined
                >
                showContent?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<boolean>
                  | undefined
          ...
          ((
            props?:
              ...
              | undefined,
          ) => Promise<import('@mirohq/websdk-types/stable/index').Frame>)
        createGroup: ((props: {
          ...
          ((props: {
            ...
            readonly id?: string | undefined
            readonly itemsIds?: string[] | undefined
          }) => Promise<import('@mirohq/websdk-types/stable/index').Group>)
        createShape: ((
          props?:
            | {
                style?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/index').ShapeStyle
                    >
                  | undefined
          ...
          ((
            props?:
              | {
                  ...
                  shape?:
                    | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                        ...
                        | 'cross'
                        | 'can'
                        | import('@mirohq/websdk-types/stable/index').ShapeType
                      >
                    | undefined
                  linkedTo?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                    string | undefined
              ...
              | undefined,
          ) => Promise<import('@mirohq/websdk-types/stable/index').Shape>)
        createMindmapNode: (
          props?:
            | {
                x?: number | undefined
                y?: number | undefined
                nodeView?:
                  | import('@mirohq/websdk-types/experimental/features/widgets/mindmapNode').MindmapNodeViewUnion
                  | {
                      style?:
                        | {
                ...
                children?:
                  | import('@mirohq/websdk-types/experimental/features/widgets/mindmapNode').MindmapCreateNodeFirstLevelChildProps[]
                  | undefined
              }
            | undefined,
        ) => Promise<
        ...
        >
        get: <
          F extends import('@mirohq/websdk-types/core/builder/types').QueryFilter<
            | import('@mirohq/websdk-types/stable/index').Connector
            | import('@mirohq/websdk-types/stable/index').Card
            | import('@mirohq/websdk-types/stable/index').AppCard
            | import('@mirohq/websdk-types/stable/index').Tag
            ...
            | import('@mirohq/websdk-types/stable/index').Image
            | import('@mirohq/websdk-types/stable/index').Preview
            | import('@mirohq/websdk-types/stable/index').Shape
            | import('@mirohq/websdk-types/stable/index').StickyNote
            | import('@mirohq/websdk-types/stable/index').Text
            | import('@mirohq/websdk-types/stable/index').Frame
            | import('@mirohq/websdk-types/stable/index').Group
          >,
        >(
          filter?: F | undefined,
        ) => Promise<
          import('@mirohq/websdk-types/core/builder/types').QueryReturn<
            | import('@mirohq/websdk-types/stable/index').Connector
            | import('@mirohq/websdk-types/stable/index').Card
            | import('@mirohq/websdk-types/stable/index').AppCard
            | import('@mirohq/websdk-types/stable/index').Tag
        ...
        getById: (
          ...
          | import('@mirohq/websdk-types/stable/index').Connector
          | import('@mirohq/websdk-types/stable/index').Unsupported
          | import('@mirohq/websdk-types/stable/index').Card
          | import('@mirohq/websdk-types/stable/index').AppCard
          | import('@mirohq/websdk-types/stable/index').Tag
          | import('@mirohq/websdk-types/stable/index').Embed
        ...
        >
        select: <
          F_1 extends import('@mirohq/websdk-types/core/builder/types').QueryFilter<
            | import('@mirohq/websdk-types/stable/index').Connector
            | import('@mirohq/websdk-types/stable/index').Card
            | import('@mirohq/websdk-types/stable/index').AppCard
            | import('@mirohq/websdk-types/stable/index').Tag
        ...
        >
        deselect: <
          F_2 extends import('@mirohq/websdk-types/core/builder/types').QueryFilter<
            | import('@mirohq/websdk-types/stable/index').Connector
            | import('@mirohq/websdk-types/stable/index').Card
            | import('@mirohq/websdk-types/stable/index').AppCard
            | import('@mirohq/websdk-types/stable/index').Tag
        ...
        sync: (
          item: import('@mirohq/websdk-types/core/features/widgets/base').BaseItem,
        ) => Promise<void>
        getMetadata: <K extends string | undefined = undefined>(
          item: import('@mirohq/websdk-types/core/features/widgets/base').BaseItem,
          key?: K | undefined,
        ) => Promise<
          K extends string
            ? import('@mirohq/websdk-types/stable/index').Json
            : import('@mirohq/websdk-types/stable/index').AppData
        >
        setMetadata: <D extends import('@mirohq/websdk-types/stable/index').AppData>(
          item: import('@mirohq/websdk-types/core/features/widgets/base').BaseItem,
          key: string,
          value: import('@mirohq/websdk-types/stable/index').Json,
        ) => Promise<D>
        goToLink: (
          item: import('@mirohq/websdk-types/core/features/widgets/base').BaseItem,
        ) => Promise<boolean>
        bringToFront: (
          items: import('@mirohq/websdk-types/stable/index').OneOrMany<
            import('@mirohq/websdk-types/core/features/widgets/base').BaseItem
          >,
        ) => Promise<void>
        sendToBack: (
          items: import('@mirohq/websdk-types/stable/index').OneOrMany<
        ...
        bringInFrontOf: (
          items: import('@mirohq/websdk-types/stable/index').OneOrMany<
            import('@mirohq/websdk-types/core/features/widgets/base').BaseItem
          >,
          target: import('@mirohq/websdk-types/core/features/widgets/base').BaseItem,
        ) => Promise<void>
        sendBehindOf: (
          items: import('@mirohq/websdk-types/stable/index').OneOrMany<
            import('@mirohq/websdk-types/core/features/widgets/base').BaseItem
        ...
        group: (
          props: import('@mirohq/websdk-types/stable/index').CreateGroupProps,
        ) => Promise<import('@mirohq/websdk-types/stable/index').Group>
        ...
        createAppCard: (
          props?:
            | {
                style?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/index').CardStyle
                    >
                  | undefined
                title?: string | undefined
                ...
                status?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/index').AppCardStatus
                    >
                  | undefined
                readonly id?: string | undefined
                origin?: 'center' | undefined
                ...
                fields?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  import('@mirohq/websdk-types/stable/index').CardField[] | undefined
                >
                readonly owned?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<boolean>
                  | undefined
            ...
            | undefined,
        ) => Promise<import('@mirohq/websdk-types/stable/index').AppCard>
        createCard: (
          props?:
            | {
                style?:
                ...
                rotation?: number | undefined
                description?: string | undefined
                dueDate?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  string | undefined
                >
                startDate?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  string | undefined
                >
                assignee?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  import('@mirohq/websdk-types/stable/index').CardAssignee | undefined
                >
                taskStatus?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/index').CardTaskStatus
                    >
                  | undefined
                tagIds?: string[] | undefined
                fields?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
            ...
            | undefined,
        ) => Promise<import('@mirohq/websdk-types/stable/index').Card>
        createConnector: (props: {
          style?:
            | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                import('@mirohq/websdk-types/stable/index').ConnectorStyle
              >
            | undefined
          ...
          shape?:
            | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                import('@mirohq/websdk-types/stable/index').ConnectorShape
              >
            | undefined
          start?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
            import('@mirohq/websdk-types/core/features/widgets/connector').Endpoint | undefined
          >
          end?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
            import('@mirohq/websdk-types/core/features/widgets/connector').Endpoint | undefined
          >
          captions?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
            import('@mirohq/websdk-types/stable/index').ConnectorCaption[] | undefined
          >
        }) => Promise<import('@mirohq/websdk-types/stable/index').Connector>
        createEmbed: (props: {
          ...
          readonly modifiedAt?: string | undefined
          readonly modifiedBy?: string | undefined
          readonly width?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
            number | undefined
          >
          readonly height?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
            number | undefined
          >
          linkedTo?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
            string | undefined
          ...
          mode?:
            | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                import('@mirohq/websdk-types/stable/index').EmbedMode
              >
            | undefined
        }) => Promise<import('@mirohq/websdk-types/stable/index').Embed>
        createImage: (
          props: import('@mirohq/websdk-types/stable/index').ImageProps,
        ) => Promise<import('@mirohq/websdk-types/stable/index').Image>
        createPreview: (
          props: import('@mirohq/websdk-types/stable/index').PreviewProps,
        ) => Promise<import('@mirohq/websdk-types/stable/index').Preview>
        createStickyNote: (
          props?:
            | {
                style?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/index').StickyNoteStyle
                    >
                  | undefined
                ...
                shape?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/index').StickyNoteShape
                    >
                  | undefined
                linkedTo?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  string | undefined
            ...
            | undefined,
        ) => Promise<import('@mirohq/websdk-types/stable/index').StickyNote>
        createText: (
          props?:
            | {
                style?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/index').TextStyle
                    >
                  | undefined
            ...
            | undefined,
        ) => Promise<import('@mirohq/websdk-types/stable/index').Text>
        createTag: (
          props?:
            | {
                title?: string | undefined
            ...
            | undefined,
        ) => Promise<import('@mirohq/websdk-types/stable/index').Tag>
        ...
        getInfo: () => Promise<import('@mirohq/websdk-types/stable/index').BoardInfo>
        getIdToken: () => Promise<string>
        canUse: (
          feature: import('@mirohq/websdk-types/stable/index').BoardFeature,
        ) => Promise<boolean>
        getAppData: <K_1 extends string | undefined = undefined>(
          key?: K_1 | undefined,
        ) => Promise<
          K_1 extends string
            ? import('@mirohq/websdk-types/stable/index').Json
            : import('@mirohq/websdk-types/stable/index').AppData
        >
        setAppData: <D_1 extends import('@mirohq/websdk-types/stable/index').AppData>(
          key: string,
          value: import('@mirohq/websdk-types/stable/index').Json,
        ) => Promise<D_1>
        getUserInfo: () => Promise<import('@mirohq/websdk-types/stable/index').UserInfo>
        getOnlineUsers: () => Promise<import('@mirohq/websdk-types/stable/index').OnlineUserInfo[]>
        findEmptySpace: (
          dimensions: import('@mirohq/websdk-types/stable/index').Rect & {
            offset?: number | undefined
          },
        ) => Promise<import('@mirohq/websdk-types/stable/index').Rect>
      },
      'group' | 'action' | 'history' | 'getVotingResults'
    >
  >
  export const createExperimentalSdk: (
    commander: Commander<string>,
  ) => ReturnType<typeof experimentalSdkClientSchema.build>
}
...
declare module '@mirohq/websdk-types/experimental/api/customActions' {
  ...
  export interface CustomActionManagement {
    register<T extends ExperimentalClientItem>(
      customAction: CustomAction<T>,
    ): Promise<CustomAction<T>>
...
declare module '@mirohq/websdk-types/experimental/api/history' {
  export type History = {
    undo: () => Promise<void>
...
declare module '@mirohq/websdk-types/experimental/api/board' {
  ...
  import { Item } from '@mirohq/websdk-types/stable/api/client'
  import {
    MindmapCreateNodeProps,
    MindmapNode,
  } from '@mirohq/websdk-types/experimental/features/widgets/mindmapNode'
  import { Shape } from '@mirohq/websdk-types/experimental/features/widgets/shape'
  ...
  import { History } from '@mirohq/websdk-types/experimental/api/history'
...
declare module '@mirohq/websdk-types/experimental/features/customAction' {
  ...
  import { ExperimentalCommandType } from '@mirohq/websdk-types/experimental/api/commands'
  import {
    CustomActionManagement as ICustomActionManagement,
    CustomAction,
  } from '@mirohq/websdk-types/experimental/api/customActions'
...
declare module '@mirohq/websdk-types/stable/client/index' {
  ...
  export const baseSdkClientSchema: import('@mirohq/websdk-types/core/builder/types').SdkClientBuilder<
    string,
    | Connector
    | Card
    | AppCard
    ...
    | Frame
    | Group,
    import('@mirohq/websdk-types/core/builder/types').BaseFeature<
      | Connector
      | Card
      | AppCard
      | Tag
    ...
    > &
      Omit<
        {
          ...
          getAppData<K extends string | undefined = undefined>(
            ...
            K extends string
              ...
              : import('@mirohq/websdk-types/stable/index').AppData
          >
          setAppData<D extends import('@mirohq/websdk-types/stable/index').AppData>(
            key: string,
            value: import('@mirohq/websdk-types/stable/index').Json,
          ): Promise<D>
          setMetadata<D_1 extends import('@mirohq/websdk-types/stable/index').AppData>(
            item: import('@mirohq/websdk-types/core/features/widgets/base').BaseItem,
            key: string,
            value: import('@mirohq/websdk-types/stable/index').Json,
          ): Promise<D_1>
          ...
          getOnlineUsers(): Promise<import('@mirohq/websdk-types/stable/index').OnlineUserInfo[]>
          group(
            props: import('@mirohq/websdk-types/stable/features/widgets/group').CreateGroupProps,
          ): Promise<Group>
          goToLink(
            item: import('@mirohq/websdk-types/core/features/widgets/base').BaseItem,
          ): Promise<boolean>
        ...
        } & Omit<
          {
          ...
          } & Omit<
            {
              ...
              createText: (
                props?:
                  | {
                      style?:
                        | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                            import('@mirohq/websdk-types/stable/features/widgets/text').TextStyle
                          >
                        | undefined
                      readonly type?: 'text' | undefined
                      x?: number | undefined
              ...
              createStickyNote: (
                props?:
                  | {
                      style?:
                        | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                            import('@mirohq/websdk-types/stable/features/widgets/stickyNote').StickyNoteStyle
                          >
                        | undefined
                      readonly type?: 'sticky_note' | undefined
                      x?: number | undefined
                      ...
                      shape?:
                        | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                            import('@mirohq/websdk-types/stable/features/widgets/stickyNote').StickyNoteShape
                          >
                        | undefined
                      linkedTo?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                        string | undefined
              ...
              createShape: (
                props?:
                  | {
                      style?:
                        | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                            import('@mirohq/websdk-types/stable/features/widgets/shape').ShapeStyle
                          >
                        | undefined
                      readonly type?: 'shape' | undefined
                      x?: number | undefined
                      ...
                      shape?:
                        | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                            ...
                            | 'cross'
                            | 'can'
                            | import('@mirohq/websdk-types/stable/features/widgets/shape').ShapeType
                          >
                        | undefined
                      linkedTo?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                        string | undefined
              ...
              createPreview: (
                props: import('@mirohq/websdk-types/stable/features/widgets/preview').PreviewProps,
              ) => Promise<Preview>
              createImage: (
                props: import('@mirohq/websdk-types/stable/features/widgets/image').ImageProps,
              ) => Promise<Image>
              createFrame: (
                props?:
                  | {
              ...
              createEmbed: (props: {
                ...
                mode?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/stable/features/widgets/embed').EmbedMode
                    >
                  | undefined
              }) => Promise<Embed>
              createConnector: (props: {
                style?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/core/features/widgets/connector').ConnectorStyle
                    >
                  | undefined
                readonly type?: 'connector' | undefined
                readonly id?: string | undefined
                ...
                shape?:
                  | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                      import('@mirohq/websdk-types/core/features/widgets/connector').ConnectorShape
                    >
                  | undefined
                start?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  | import('@mirohq/websdk-types/core/features/widgets/connector').Endpoint
                  | undefined
                >
                end?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  | import('@mirohq/websdk-types/core/features/widgets/connector').Endpoint
                ...
                >
                captions?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                  | import('@mirohq/websdk-types/core/features/widgets/connector').ConnectorCaption[]
                  | undefined
                >
              }) => Promise<Connector>
              createCard: (
                props?:
                  | {
                      style?:
                        | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                            import('@mirohq/websdk-types/stable/features/widgets/card').CardStyle
                          >
                        | undefined
                      title?: string | undefined
                      readonly type?: 'card' | undefined
                      ...
                      >
                      assignee?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                        | import('@mirohq/websdk-types/stable/features/widgets/card').CardAssignee
                        | undefined
                      >
                      taskStatus?:
                        | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                            import('@mirohq/websdk-types/stable/features/widgets/card').CardTaskStatus
                          >
                        | undefined
                      tagIds?: string[] | undefined
                      fields?: import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                        | import('@mirohq/websdk-types/stable/features/widgets/card').CardField[]
                        | undefined
                      >
                    }
                  | undefined,
              ...
              createAppCard: (
                props?:
                  | {
                      ...
                      status?:
                        | import('@mirohq/websdk-types/core/builder/types').DeepPartial<
                            import('@mirohq/websdk-types/stable/features/widgets/appCard').AppCardStatus
                          >
                        | undefined
                      readonly id?: string | undefined
                      origin?: 'center' | undefined
            ...
            'storage' | 'timer' | 'ui' | 'notifications' | 'viewport' | 'events' | 'collaboration'
          >,
          | 'sync'
          | 'getMetadata'
          | 'setMetadata'
          ...
          | 'findEmptySpace'
        >,
        keyof import('@mirohq/websdk-types/core/builder/types').BaseFeature<
          | Connector
          | Card
          | AppCard
          | Tag
      ...
      >
  >
  export const stableSdkClientSchema: import('@mirohq/websdk-types/core/builder/types').SdkClientBuilder<
    string,
    | Connector
    | Card
    | AppCard
    ...
    | Group,
    {
      experimental: Readonly<{
        ...
        timer: Timer
        group: (
          props: import('@mirohq/websdk-types').CreateGroupExperimentalProps,
        ) => Promise<import('@mirohq/websdk-types').GroupExperimental>
        remove: (item: import('@mirohq/websdk-types/core/builder/types').BaseItem) => Promise<void>
        createAppCard: (
          props?:
            | {
    ...
    >
  >
  export const createStableSdk: (
    commander: Commander<string>,
  ) => ReturnType<typeof stableSdkClientSchema.build>
}
...
declare module '@mirohq/websdk-types/experimental/api/widgets/mindmapNode' {
  ...
  import type { MindmapNode } from '@mirohq/websdk-types/experimental/features/widgets/mindmapNode'
  export type {
    MindmapCreateNodeChildProps,
    MindmapCreateNodeFirstLevelChildProps,
    MindmapCreateNodeProps,
    MindmapCreateNodeViewDefaultChild,
    MindmapCreateNodeViewDefaultRoot,
    MindmapNodeCreate,
    ...
    MindmapNodeViewBase,
    MindmapNodeViewTypeUnion,
    MindmapNodeViewUnion,
    MindmapShapeNodeView,
    MindmapTextNodeView,
  } from '@mirohq/websdk-types/experimental/features/widgets/mindmapNode'
...
declare module '@mirohq/websdk-types/experimental/api/widgets/group' {
  ...
  export type {
    CreateGroupProps,
    GroupableItem,
  } from '@mirohq/websdk-types/experimental/features/widgets/group'
...
declare module '@mirohq/websdk-types' {
  ...
  export * from '@mirohq/websdk-types/experimental/api/history'
  export * from '@mirohq/websdk-types/experimental/api/widgets/mindmapNode'
  export type {
    ContainableItem as ExperimentalContainableItem,
    Frame as FrameExperimental,
    FrameProps as FrameExperimentalProps,
  } from '@mirohq/websdk-types/experimental/api/widgets/frame'
  export type {
    CreateGroupProps as CreateGroupExperimentalProps,
    Group as GroupExperimental,
    GroupProps as GroupExperimentalProps,
    GroupableItem as ExperimentalGroupableItem,
  } from '@mirohq/websdk-types/experimental/api/widgets/group'
  export type {
    Shape as ShapeExperimental,
    ShapeName,
    ShapeProps as ShapeExperimentalProps,
  } from '@mirohq/websdk-types/experimental/api/widgets/shape'
  global {
    var miro: Miro
  }
}
