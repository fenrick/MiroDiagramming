...
describe("graph service methods",
  () => {
    ...
    test("findNode delegates to default builder",
      async () => {
        const spy = jest
    ...
    test("createNode delegates to default builder",
      async () => {
        const spy = jest
    ...
    test("createEdges delegates to default builder",
      async () => {
        const spy = jest
    ...
    test("syncAll delegates to default builder",
      async () => {
