...
describe("frame-tools",
  () => {
    ...
    test("renameSelectedFrames updates titles in order",
      async () => {
        const frames = [
    ...
    test("renameSelectedFrames preserves this context for sync",
      async () => {
    ...
    test("renameSelectedFrames ignores non-frames",
      async () => {
        const items = [
    ...
    test("renameSelectedFrames does nothing when selection empty",
      async () => {
        const board: BoardLike =
    ...
    test("renameSelectedFrames sorts by y when x equal",
      async () => {
        const frames = [
    ...
    test("renameSelectedFrames handles frames without sync or coordinates",
      async () => {
    ...
    test("renameSelectedFrames sorts frames missing coordinates",
      async () => {
        const frames = [
          { title: "A", type: "frame" },
    ...
    test("renameSelectedFrames handles missing y for sort",
      async () => {
        const frames = [
    ...
    test("renameSelectedFrames throws without board",
      async () =>
    ...
    describe("lockSelectedFrames",
      () => {
        test("locks frames and children",
          async () => {
        ...
        test("locks frames without children",
          async () => {
            const frame = {
              type: "frame",
              locked: false,
        ...
        test("locks frame even when getChildren missing",
          async () => {
        ...
        test("does nothing when selection empty",
          async () => {
            const board: BoardLike = {
              getSelection: jest.fn().mockResolvedValue([]),
            };
        ...
        test("ignores non-frame widgets",
          async () => {
