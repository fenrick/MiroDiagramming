...
describe('BoardBuilder.removeItems', function () {
  ...
  test('removes provided items from board', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var remove, builder, items;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            remove = jest.fn();
            global.miro = { board: { remove: remove } };
            builder = new BoardBuilder_1.BoardBuilder();
            items = [{}, {}];
            return [4 /*yield*/, builder.removeItems(items)];
          case 1:
            _a.sent();
  ...
  test('throws when board not initialized', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var builder;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              expect(builder.removeItems([{}])).rejects.toThrow(
