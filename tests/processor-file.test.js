 ...
 */
describe('GraphProcessor.processFile', function () {
  afterEach(function () {
    jest.restoreAllMocks();
  });
  test('throws on invalid file', function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              expect(gp.processFile(null)).rejects.toThrow('Invalid file'),
            ];
          case 1:
            // Passing null should reject immediately
            _a.sent();
  ...
  test('loads graph then processes it', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var gp, mockGraph, processSpy, file;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            gp = new GraphProcessor_1.GraphProcessor();
            ...
            jest
              .spyOn(graph_1.graphService, 'loadGraph')
              .mockResolvedValue(mockGraph);
            processSpy = jest
              .spyOn(gp, 'processGraph')
              .mockResolvedValue(undefined);
            file = { name: 'g.json' };
            return [4 /*yield*/, gp.processFile(file)];
          case 1:
            _a.sent();
            expect(graph_1.graphService.loadGraph).toHaveBeenCalledWith(file);
