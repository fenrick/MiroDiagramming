  ...
  test('passes through short messages', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, (0, notifications_1.showError)('fail')];
          case 1:
            _a.sent();
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            long = 'a'.repeat(90);
            return [4 /*yield*/, (0, notifications_1.showError)(long)];
          case 1:
            _a.sent();
            expect(console.error).toHaveBeenCalledWith(long);
            arg = global.miro.board.notifications.showError.mock.calls[0][0];
