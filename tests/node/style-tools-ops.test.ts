...
describe('style-tools ops', () => {
  ...
  it('tweakFillColor adjusts fill and preserves contrast', async () => {
    ...
    const style = selection[0].style as any
