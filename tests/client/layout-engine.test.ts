...
describe('LayoutEngine', () => {
  test('getInstance returns the exported singleton', () => {
    ...
    ;(LayoutEngine as unknown as { instance?: LayoutEngine }).instance = undefined
  ...
  test('layoutGraph forwards options', async () => {
    ...
    await layoutEngine.layoutGraph(graph as Parameters<typeof layoutEngine.layoutGraph>[0], {
      algorithm: 'force',
      direction: 'LEFT',
      spacing: 50,
    })
