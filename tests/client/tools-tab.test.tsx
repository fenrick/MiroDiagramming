...
vi.mock('@mirohq/design-system', async () => {
  ...
  const IconButton = ({ children, ...props }: { children: React.ReactNode }) => (
    <button {...props}>{children}</button>
  )
  const IconQuestionMarkCircle = () => <svg data-testid="icon" />
  const Tooltip = ({ children }: { children: React.ReactNode }) => <div>{children}</div>
  Tooltip.Provider = ({ children }: { children: React.ReactNode }) => <div>{children}</div>
  Tooltip.Trigger = ({ children }: { children: React.ReactNode }) => <span>{children}</span>
  Tooltip.Content = ({ children }: { children: React.ReactNode }) => (
    <div role="tooltip">{children}</div>
  )
  Tooltip.Portal = ({ children }: { children: React.ReactNode }) => <div>{children}</div>
...
vi.mock('../src/ui/pages/ResizeTab', () => {
  const ResizeTabMock: React.FC = () => <div data-testid="resize-tab">Resize</div>
...
vi.mock('../src/ui/pages/ArrangeTab', () => {
  const ArrangeTabMock: React.FC = () => <div data-testid="arrange-tab">Arrange</div>
  return { ArrangeTab: ArrangeTabMock }
})
vi.mock('../src/ui/pages/FramesTab', () => {
  const FramesTabMock: React.FC = () => <div data-testid="frames-tab">Frames</div>
